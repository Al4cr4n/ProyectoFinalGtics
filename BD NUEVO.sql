...
(`idcodigoDespachador`,`codigoDespachador`, `estado`) VALUES
(1,'DESP001', 'Activo'),
(2,'DESP002', 'Inactivo'),
(3,'DESP003', 'Activo'),
(4,'DESP004', 'Pendiente'),
...
(11, 'DESP011', 'Activo'),
(12, 'DESP012', 'Inactivo'),
(13, 'DESP013', 'Pendiente'),
(14, 'DESP014', 'Activo'),
(15, 'DESP015', 'Inactivo'),
(16, 'DESP016', 'Activo'),
(17, 'DESP017', 'Pendiente'),
(18, 'DESP018', 'Activo'),
(19, 'DESP019', 'Inactivo'),
(20, 'DESP020', 'Pendiente'),
(21, 'DESP021', 'Activo'),
(22, 'DESP022', 'Pendiente'),
(23, 'DESP023', 'Inactivo'),
(24, 'DESP024', 'Activo'),
(25, 'DESP025', 'Pendiente'),
(26, 'DESP026', 'Inactivo'),
(27, 'DESP027', 'Activo'),
(28, 'DESP028', 'Inactivo'),
(29, 'DESP029', 'Pendiente'),
(30, 'DESP030', 'Activo'),
(31, 'DESP031', 'Activo'),
(32, 'DESP032', 'Inactivo'),
(33, 'DESP033', 'Pendiente'),
(34, 'DESP034', 'Activo'),
(35, 'DESP035', 'Pendiente'),
(36, 'DESP036', 'Inactivo'),
(37, 'DESP037', 'Activo'),
(38, 'DESP038', 'Pendiente'),
(39, 'DESP039', 'Inactivo'),
(40, 'DESP040', 'Activo');
...
CREATE TABLE IF NOT EXISTS `db_grupo2`.`usuario` (
  ...
  INDEX `fk_usuario_codigodespachador1_idx` (`idcodigodespachador` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_usuario_codigodespachador1`
    FOREIGN KEY (`idcodigodespachador`)
    REFERENCES `db_grupo2`.`codigodespachador` (`idcodigoDespachador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 36
DEFAULT CHARACTER SET = utf8mb3;
INSERT INTO `usuario` (`idusuario`, `nombre`, `apellido`, `dni`, `contrasena`, `direccion`, `ruc`, `notificaciones`, `correo`, `telefono`, `estadoUsuario`, `codigoJurisdiccion`, `codigoDespachador`, `razonSocial`, `solicitudAgente`, `isBan`, `idroles`,`distritos_iddistritos`,`idzona`,`fechanacim`, `estado`,`idproveedor`,`idcodigodespachador`)
VALUES
-- --Un superadmin--
(1, 'Juan', 'Pérez', '87654301', 'pass111', 'Calle Luna 100', '20123456701',  'Notificaciones Activas', 'juan.perez@example.com', '987654321', 'Activo', 'JUR101', 'DES401', 'Pérez SAC',0, 0, 1,1,1,NULL,'activo', 1,NULL),
