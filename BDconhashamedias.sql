UNLOCK TABLES;
DROP DATABASE `db_grupo2`;
CREATE DATABASE  IF NOT EXISTS `db_grupo2` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_grupo2`;
...
INSERT INTO `ordenes` VALUES (1,'CREADO','2024-09-22',1,'Enero'),(2,'CREADO','2024-09-23',2,'Febrero'),(3,'CREADO','2024-09-24',3,'Marzo'),(4,'CREADO','2024-09-25',4,'Abril'),(5,'EN VALIDACIÓN','2024-09-26',5,'Mayo'),(6,'EN VALIDACIÓN','2024-09-27',6,'Junio'),(7,'EN VALIDACIÓN','2024-09-28',7,'Julio'),(8,'EN VALIDACIÓN','2024-09-29',8,'Agosto'),(9,'EN PROCESO','2024-09-30',9,'Septiembre'),(10,'EN PROCESO','2024-10-01',10,'Octubre'),(11,'EN PROCESO','2024-10-02',11,'Noviembre'),(12,'EN PROCESO','2024-10-03',12,'Diciembre'),(13,'ARRIBO AL PAÍS','2024-10-04',13,'Enero'),(14,'ARRIBO AL PAÍS','2024-10-05',14,'Febrero'),(15,'ARRIBO AL PAÍS','2024-10-06',15,'Marzo'),(16,'ARRIBO AL PAÍS','2024-10-07',16,'Abril'),(17,'EN ADUANAS','2024-10-08',17,'Mayo'),(18,'EN ADUANAS','2024-10-09',18,'Junio'),(19,'EN ADUANAS','2024-10-10',19,'Julio'),(20,'EN ADUANAS','2024-10-11',20,'Agosto'),(21,'EN RUTA','2024-10-12',21,'Septiembre'),(22,'EN RUTA','2024-10-13',22,'Octubre'),(23,'EN RUTA','2024-10-14',23,'Noviembre'),(24,'EN RUTA','2024-10-15',24,'Diciembre'),(25,'RECIBIDO','2024-10-16',25,'Enero'),(26,'RECIBIDO','2024-10-17',26,'Febrero'),(27,'RECIBIDO','2024-10-18',27,'Marzo'),(28,'RECIBIDO','2024-10-19',28,'Abril');
...
INSERT INTO `resenias` VALUES (26,'Excelente producto, lo recomendaría a todos.','Alta','Rápida',5,NULL,'Gracias por tu comentario!',1,'Recomendación de Producto A','Me encantó el Producto A, superó mis expectativas.',29,'Foro'),(27,'Buen rendimiento, aunque podría mejorar la calidad.','Media','Moderada',4,NULL,'Agradecemos tu feedback.',2,'Opinión sobre Producto B','El Producto B es bueno, pero creo que necesita ajustes.',30,'Foro'),(28,'No estoy satisfecho con el servicio.','Baja','Lenta',2,NULL,'Lamentamos que hayas tenido esta experiencia.',3,'Crítica del Producto C','El Producto C no cumplió con mis expectativas.',31,'Reseña'),(29,'Gran relación calidad-precio.','Alta','Rápida',5,NULL,'Nos alegra que lo pienses así.',1,'Producto D recomendado','El Producto D es muy bueno y económico.',32,'Foro'),(30,'El producto llegó dañado.','Baja','Lenta',1,NULL,'Lamentamos lo ocurrido, te ayudaremos.',4,'Problema con el Producto E','No estoy contento con la entrega, llegó en mal estado.',33,'Reseña');
...
INSERT INTO `usuario` VALUES (1,'Juan','Pérez','87654301','$2a$10$qEX3x5f6Kq4w21WiVBfcweb06G68O13jsbjU.GnxNa4BIdeF1HGN.','Calle Luna 100','20123456701','Notificaciones Activas','juan.perez@example.com','987654321','Baneado','JUR101','DES401','Pérez SAC',0,0,1,NULL,1,NULL,'baneado',1,NULL,'Datos falsos'), -- contrasena : pass111 --
(2,'Maria','López','87654302','$2a$10$eoJb9OxdsfolkWLbzFZTNO7lyZ9ldKsesVP8Twx0NAxpsm74DX5dK','Av. Sol 200','20123456702','Notificaciones Inactivas','maria.lopez@example.com','912345678','Baneado','JUR102','DES402','López EIRL',0,0,1,NULL,2,'1993-01-17','baneado',1,2,'Mal comportamiento'), -- contrasena : pass222 --
(3,'Carlos','García','87654303','$2a$10$YJK9ma/b1R6ojur0EOdR1.e7c0APC8J16bK.NizXZ9lKPY/qrXX/2','Calle Estrella 300','20123456703','Notificaciones Activas','carlos.garcia@example.com','923456789','Inactivo','JUR103','DES403','García SAC',0,0,3,7,1,'1994-08-24','activo',10,1,NULL), -- contrasena : pass333 --
(4,'Laura','Ramírez','87654304','$2a$10$X72zAxF4BoEHqy9mknKPNeXRUP/bhayl7g/np57wrLdCCdkxslnxW','Av. Luna 400','20123456704','Notificaciones Inactivas','laura.ramirez@example.com','934567890','Activo','JUR104','DES404','Ramírez EIRL',0,0,2,3,1,'1987-11-15','activo',2,NULL,NULL), -- contrasena : pass444 --
(5,'Pedro','Fernández','87654305','$2a$10$FBWzZhCuOmtxMdkaCh1OjeHxnIcxpNQm10W3EASwMQSpXS59zHA66','Calle Mar 500','20123456705','Notificaciones Activas','pedro.fernandez@example.com','945678901','Inactivo','JUR105','DES405','Fernández SAC',0,0,2,5,1,'1990-02-22','activo',3,NULL,NULL), -- contrasena : pass555 --
(6,'Elena','Castro','87654306','$2a$10$wf6xrt0C6SuiNAYNw7qya.ysKJPSGwLn4syggVkS0fbargzX7tHtS','Av. Roca 600','20123456706','Notificaciones Activas','elena.castro@example.com','956789012','Activo','JUR106','DES406','Castro EIRL',0,0,3,12,2,'1987-11-11','activo',2,3,NULL), -- contrasena : pass666 --
(7,'Raúl','Torres','87654307','$2a$10$fWvJH2MIxwtWX6iRsDfrnuhsUF2ySLX3JIC6XPg7BCaLFOx8LV5EK','Calle Nube 700','20123456707','Notificaciones Inactivas','raul.torres@example.com','967890123','Activo','JUR107','DES407','Torres SAC',1,0,4,3,1,'1994-06-07','baneado',7,8,NULL); -- contrasena : pass777 --
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;
UNLOCK TABLES;
-- (8,'Sofía','Vargas','87654308','pass888','Av. Arena 800','20123456708','Notificaciones Activas','sofia.vargas@example.com','978901234','Inactivo','JUR108','DES408','Vargas EIRL',0,0,4,13,2,'1994-01-12','inactivo',2,13,NULL),(9,'Jorge','Díaz','87654309','pass999','Calle Sol 900','20123456709','Notificaciones Inactivas','jorge.diaz@example.com','989012345','Activo','JUR109','DES409','Díaz SAC',1,0,4,23,3,'1993-11-09','activo',7,18,NULL),(10,'Lucía','Mendoza','87654310','pass1010','Av. Viento 1000','20123456710','Notificaciones Activas','lucia.mendoza@example.com','990123456','Activo','JUR110','DES410','Mendoza EIRL',1,0,4,4,1,'1993-09-20','activo',8,9,NULL),(11,'Ana','Rojas','87654311','pass1111','Calle Fuego 1100','20123456711','Notificaciones Inactivas','ana.rojas@example.com','991234567','Activo','JUR111','DES411','Rojas SAC',1,0,4,5,1,'1989-12-27','activo',9,10,NULL),(12,'Luis','Ortiz','87654312','pass1212','Av. Brisa 1200','20123456712','Notificaciones Activas','luis.ortiz@example.com','992345678','Inactivo','JUR112','DES412','Ortiz EIRL',1,0,4,24,3,'1988-12-21','inactivo',8,19,NULL),(13,'Gloria','Paredes','87654313','pass1313','Calle Trueno 1300','20123456713','Notificaciones Activas','gloria.paredes@example.com','993456789','Activo','JUR113','DES413','Paredes SAC',0,0,4,14,2,'1995-12-02','inactivo',3,14,NULL),(14,'Andrés','Guzmán','87654314','pass1414','Av. Relámpago 1400','20123456714','Notificaciones Inactivas','andres.guzman@example.com','994567890','Inactivo','JUR114','DES414','Guzmán EIRL',0,0,4,6,1,'1995-05-04','activo',10,11,NULL),(15,'Patricia','Montes','87654315','pass1515','Calle Lluvia 1500','20123456715','Notificaciones Activas','patricia.montes@example.com','995678901','Activo','JUR115','DES415','Montes SAC',1,0,4,15,2,'1989-05-15','activo',4,15,NULL),(16,'Gabriel','Salazar','87654316','pass1616','Av. Viento 1600','20123456716','Notificaciones Inactivas','gabriel.salazar@example.com','996789012','Activo','JUR116','DES416','Salazar EIRL',1,0,4,23,3,'1987-01-28','inactivo',9,20,NULL),(17,'Daniela','Cruz','87654317','pass1717','Calle Rayo 1700','20123456717','Notificaciones Activas','daniela.cruz@example.com','997890123','Inactivo','JUR117','DES417','Cruz SAC',0,0,4,16,2,'1987-03-11','inactivo',5,16,NULL),(18,'Hugo','Mejía','87654318','pass1818','Av. Truenos 1800','20123456718','Notificaciones Inactivas','hugo.mejia@example.com','998901234','Activo','JUR118','DES418','Mejía EIRL',1,0,4,7,1,'1988-07-30','activo',1,12,NULL),(19,'Camila','Vega','87654319','pass1919','Calle Ríos 1900','20123456719','Notificaciones Activas','camila.vega@example.com','999012345','Activo','JUR119','DES419','Vega SAC',1,0,4,17,2,'1992-10-17','activo',6,17,NULL),(20,'Alonso','Valdez','87654320','pass2020','Av. Roca 2000','20123456720','Notificaciones Inactivas','alonso.valdez@example.com','990123456','Inactivo','JUR120','DES420','Valdez EIRL',0,0,4,22,3,'1989-08-03','inactivo',10,21,NULL),(21,'Diego','Navarro','87654321','pass2121','Calle Verde 2100','20123456721','Notificaciones Activas','diego.navarro@example.com','991112233','Activo','JUR121','DES421','Navarro SAC',0,0,4,29,4,'1991-09-12','activo',1,22,NULL),(22,'Mónica','Zambrano','87654322','pass2222','Av. Sol 2200','20123456722','Notificaciones Inactivas','monica.zambrano@example.com','992223344','Inactivo','JUR122','DES422','Zambrano EIRL',1,0,4,30,4,NULL,'inactivo',2,23,NULL),(23,'Javier','Cárdenas','87654323','pass2323','Calle Luna 2300','20123456723','Notificaciones Activas','javier.cardenas@example.com','993334455','Activo','JUR123','DES423','Cárdenas SAC',0,0,4,31,4,NULL,'activo',3,24,NULL),(24,'Carolina','Sánchez','87654324','pass2424','Av. Estrella 2400','20123456724','Notificaciones Inactivas','carolina.sanchez@example.com','994445566','Activo','JUR124','DES424','Sánchez EIRL',1,0,4,32,4,NULL,'activo',4,25,NULL),(26,'Rodrigo','Flores','87654326','pass2626','Av. Pino 2600','20123456726','Notificaciones Activas','rodrigo.flores@example.com','996112233','Activo','JUR126','DES426','Flores SAC',0,0,2,9,2,'1993-03-18','activo',4,NULL,NULL),(27,'Valeria','Huerta','87654327','pass2727','Calle Sauce 2700','20123456727','Notificaciones Inactivas','valeria.huerta@example.com','997223344','Inactivo','JUR127','DES427','Huerta EIRL',1,0,2,10,2,'1991-05-09','activo',5,NULL,NULL),(28,'Francisco','Pinto','87654328','pass2828','Av. Cedro 2800','20123456728','Notificaciones Activas','francisco.pinto@example.com','998334455','Activo','JUR128','DES428','Pinto SAC',0,0,2,19,3,'1992-07-22','activo',6,NULL,NULL),(29,'Gabriela','Montalvo','87654329','pass2929','Calle Abeto 2900','20123456729','Notificaciones Inactivas','gabriela.montalvo@example.com','999445566','Activo','JUR129','DES429','Montalvo EIRL',1,0,2,20,3,'1988-10-30','activo',7,NULL,NULL),(30,'Sergio','Villalobos','87654330','pass3030','Av. Olivo 3000','20123456730','Notificaciones Activas','sergio.villalobos@example.com','990556677','Inactivo','JUR130','DES430','Villalobos SAC',0,0,2,25,4,'1989-12-14','activo',8,NULL,NULL),(31,'Elisa','Cabrera','87654331','pass3131','Calle Roble 3100','20123456731','Notificaciones Activas','elisa.cabrera@example.com','991667788','Activo','JUR131','DES431','Cabrera EIRL',1,0,2,26,4,'1995-06-19','activo',9,NULL,NULL),(32,'Miguel','Ortega','87654332','pass3232','Av. Pino 3200','20123456732','Notificaciones Inactivas','miguel.ortega@example.com','992778899','Activo','JUR132','DES432','Ortega SAC',0,0,3,21,3,'1990-03-29','activo',3,4,NULL),(33,'Luciana','Rivera','87654333','pass3333','Calle Sauce 3300','20123456733','Notificaciones Activas','luciana.rivera@example.com','993889900','Activo','JUR133','DES433','Rivera EIRL',1,0,3,22,3,'1988-05-06','activo',4,5,NULL),(34,'Julio','Escobar','87654334','pass3434','Av. Cedro 3400','20123456734','Notificaciones Inactivas','julio.escobar@example.com','994990011','Inactivo','JUR134','DES434','Escobar SAC',0,0,3,27,4,'1991-04-25','activo',5,6,NULL),(35,'Natalia','Castillo','87654335','pass3535','Calle Abeto 3500','20123456735','Notificaciones Activas','natalia.castillo@example.com','995001122','Activo','JUR135','DES435','Castillo EIRL',1,0,3,28,4,'1992-08-14','activo',6,7,NULL);
...
-- Dump completed on 2024-10-02  1:53:51
